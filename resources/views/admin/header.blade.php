...
<!-- Mirrored from coderthemes.com/hyper/saas/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Sun, 31 Jul 2022 14:49:16 GMT -->
<head>
        <meta charset="utf-8" />
                        ...
                        <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarDashboards">
                                <ul class="side-nav-second-level">
                                    <li>
                                        <a href="{{ url('/shelter/add-pet') }}">Add pet</a>
                                    </li>
                                    <li>
                                        <a href="{{ route('shelter.adoption.requests') }}">Addoption Requests</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/shelter/appointments') }}">My Appointments</a>
                                    </li>                                
                                </ul>
                            </div>
                        </li>
                        ...
                        {{-- <li class="side-nav-item">
                            ...
                            <div class="collapse" id="sidebarCrm">
                                <ul class="side-nav-second-level">
                                    ...
                                    <li>
                                        <a href="{{ url('/shelter/add-pet') }}">Addoption Requests</a>
                                    </li>
                                    <li>
                                        <a href="{{ url('/shelter/requests') }}">Add Pet</a>
                                    </li>
                                    <li>
                        ...
                        <ul class="list-unstyled topbar-menu float-end mb-0">
                            ...
                            <li class="dropdown notification-list">
                                <a class="nav-link dropdown-toggle nav-user arrow-none me-0" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false"
                                    ...
                                    <span>
                                        <span class="account-user-name">@if(session('Adminid'))
                                            {{session('Adminname')}}
                                            @else
                                            Admin
                                            @endif
