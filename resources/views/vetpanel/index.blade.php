                                    ...
                                    <div class="col-sm-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted fw-normal mt-0" title="Number of Customers">Total Appointments</h5>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="card widget-flat">
                                            <div class="card-body">
                                                ...
                                                <h5 class="text-muted fw-normal mt-0" title="Growth">Approved</h5>
                                                <h3 class="mt-3 mb-3">{{$approved}}</h3>
                                                <p class="mb-0 text-muted">
